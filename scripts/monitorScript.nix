...
pkgs.writeShellScriptBin "monitorScript" ''
  ...
  #   then
  #     ${pkgs.xrandr}/bin/xrandr --newmode "3440x1440_60.00r" 319.75  3440 3488 3520 3600  1440 1443 1453 1481 +hsync -vsync 
  #     ${pkgs.xrandr}/bin/xrandr --addmode HDMI-1 "3440x1440_60.00r"
  #     ${pkgs.xrandr}/bin/xrandr --output HDMI-1 --mode "3440x1440_60.00r" --above eDP-1
  #   else
